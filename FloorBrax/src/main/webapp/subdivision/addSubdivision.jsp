...
<body>
  ...
  <div class="container">
    ...
    <div class="container mt-4">
        <form action="http://localhost:8080/FloorBrax/addSubdivisionServlet" method="post">
            <div class="row">
               <div class="col-sm">
                    <label>Name</label>
                ...
                <div class="col-sm">
                    <label>Address</label>
                    <input class="form-control mr-2" type="text" id="address" name="address">
                </div>
                <div class="col-sm">
                    <button class="btn btn-primary mt-4 float-right" type="submit">Submit Subdivision</button>
                </div>
            </div>
        </form>
    </div>
