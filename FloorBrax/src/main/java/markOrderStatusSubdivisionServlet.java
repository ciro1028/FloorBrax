 ...
 * @author Ciro
 */
@WebServlet(urlPatterns = {"/markOrderStatusSubdivisionServlet"})
public class markOrderStatusSubdivisionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            orderList = subdivision.getOrdersList(Integer.parseInt(order.getSubdivision()));
            
            HttpSession session = request.getSession();
            session.setAttribute("orderList", orderList);
            
            response.sendRedirect("orderSearchBySubdivision.jsp");
        }
    }
