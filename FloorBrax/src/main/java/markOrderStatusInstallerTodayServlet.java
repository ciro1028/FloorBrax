 ...
 * @author Ciro
 */
@WebServlet(urlPatterns = {"/markOrderStatusInstallerTodayServlet"})
public class markOrderStatusInstallerTodayServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            orderList = installer.getTodayOrders(installer.getId());
            
            
            session.setAttribute("todaysOrders", orderList);
            
            response.sendRedirect("installer/editInstaller.jsp");
        }
    }
