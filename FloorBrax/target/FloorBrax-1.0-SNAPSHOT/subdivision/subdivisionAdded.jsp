<%-- 
    Document   : subdivisionAdded
    Created on : May 17, 2018, 4:26:00 PM
    Author     : Ciro
--%>
    ...
    <div class="container mt-4">
        <div class="row">
               <div class="col-sm">
                ...
                <div class="col-sm">
                    <button class="btn btn-primary float-right mt-4" type="button" data-toggle="modal" data-target="#deleteModal">Delete Subdivision</button> 
                </div>
            </div>
    </div>    
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
              <form action="http://localhost:8080/FloorBrax/deleteSubdivisionServlet" method="post">
