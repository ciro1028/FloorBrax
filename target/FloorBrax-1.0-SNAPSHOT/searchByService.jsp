...
<body>
    ...
    <div class="container">
        <form action="http://floor.us-east-1.elasticbeanstalk.com/searchOrdersServiceServlet" method="post"
            <div class="input-group mt-4">
                <input class="form-control" type="text" name="service" placeholder="Enter Name of Service" required>
