                ...
                <div class="col-sm">
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input class="form-control mr-2 text-right" type="text" id="priceSqf" name="price" 
                                   value="<c:out value="${sessionScope.service.pricePerSquareFoot}"/>">
                        </div>
                        <div class="col">
                            <label>Price per sqf to pay</label>
                            <input class="form-control mr-2 text-right" type="text" id="pricePaySqf" name="pricePay" 
                ...
                <div class="col-sm">
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input class="form-control mr-2 text-right" type="text" id="priceDitra" name="price" 
                                   value="<c:out value="${sessionScope.service.priceperSquareFootDitra}"/>">
                        </div>
                        <div class="col">
                            <label>Price w/ ditra to Pay</label>
                            <input class="form-control mr-2 text-right" type="text" id="pricePayDitra" name="pricePay" 
                                   value="<c:out value="${sessionScope.service.priceperSquareFootDitraToPay}"/>">
                        </div>
                    </div>
                </div>
            </div>
                <button class="btn btn-primary float-right mt-4" type="button" data-toggle="modal" data-target="#deleteModal">Delete Service</button> 
    </div>    
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
              <form action="http://floor.us-east-1.elasticbeanstalk.com/deleteService" method="post">
