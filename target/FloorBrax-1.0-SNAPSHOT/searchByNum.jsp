<%-- 
    Document   : searchByNum
    Created on : May 18, 2018, 6:26:17 PM
    Author     : Ciro
--%>
...
<body>
    ...
    <div class="container">
        <form action="http://floor.us-east-1.elasticbeanstalk.com/goToOrderSelectedServlet" method="post"
            <div class="input-group mt-4">
                <input class="form-control" type="text" name="num" placeholder="Enter Name of Order Number" required>
