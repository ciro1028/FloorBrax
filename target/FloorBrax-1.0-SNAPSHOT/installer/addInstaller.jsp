...
<body>
  ...
  <div class="container">
    ...
    <div class="container">
        <div class="container">
            <div class="row float-right mt-2"><small><label>User: </label><label class="ml-1" id="userLabel"><c:out value="${user.name}"/></label></small></div>
        </div>
    </div>  
        ...
        <form action="http://floor.us-east-1.elasticbeanstalk.com/addInstallersServlet" method="post">
            <div class="row">
               <div class="col-sm">
                ...
                <div class="col-sm">
                    <button class="btn btn-primary mt-4 float-right" type="submit">Submit Installer</button>
                </div>
            </div>
        </form>
    </div>
