    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="dropdown">
          ...
          <div class="dropdown-menu">
            <a href="addInstaller.jsp" class="dropdown-item">Add Installer</a>
            <a href="searchInstaller.jsp" class="dropdown-item">Search Installer</a>
          </div>
        </div>
      </div>
      <div class="col-md-3">
  ...
  <div class="container my-4">
    ...
    <div class="container">
        <div class="alert alert-danger text-center">
            <c:out value="${sessionScope.installer.name}"/>'s orders for today.
        </div>
    </div>
    <div class="container">
      ...
      <tbody>
          ...
          <c:forEach items="${sessionScope.todaysOrders}" var="order" varStatus="loop">
              <c:set var="orders" value="${orders}${order.orderNum}%"/>
                  <tr>
                    ...
                    <td class="text-center"><c:out value="${sessionScope.ordersSubs[loop.index]}"/></td>
        ...
        <input id="orders_num" type="text" value="${orders}" hidden="true" onload="getSatus()">
      </tbody>
    </table>
    </div>
