<%-- 
    Document   : orderSearchByDateResult
    Created on : May 18, 2018, 3:45:50 PM
    Author     : Ciro
--%>
...
<body onload="getStatus()">
        ...
        <div class="container">
            <div 
                ...
                <small>
                    ...
                    <label 
                        class="ml-1" 
                        id="userLabel"><c:out value="${sessionScope.user.name}"/>
                    </label>
                </small>
            </div>
        </div>
    ...
    <div class="container">
        <h4 class="bg-primary p-2 w-100 text-center text-white mt-4">List of orders</h4>
    </div>
    <div class="container">
        <div class="row">
