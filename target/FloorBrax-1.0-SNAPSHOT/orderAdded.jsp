                ...
                <div class="row">
                    <div class="col-sm">
                        ...
                        <input 
                            ...
                            id="order_num" 
                            name="orderNum" 
                            value="<c:out value="${sessionScope.order.orderNum}"/>" disabled required>
                        <label class="mt-2 text-dark">Date:</label><br>
                        <input 
                            class="form-control font-weight-bold ml-2 text-primary text-right border border-dark pr-2" 
                            id="datepicker" 
                            name="datepicker" 
                            value="<c:out value="${sessionScope.order.date}"/>" disabled required>    
                        <label class="mt-2 text-dark">Subdivision:</label><br>
                        <input 
                            class="form-control font-weight-bold ml-2 text-primary text-right border border-dark pr-2" 
                            id="sub" 
                            name="sub" 
                            value="<c:out value="${sessionScope.sub}"/>" disabled>
                        <select class="form-control ml-2" id="subdivision" name="subdivision" required hidden="true">
                            ...
                            <c:forEach items="${sessionScope.listOfSubdivisions}" var="sub">
                                <option value="<c:out value="${sub.name}"/>"><c:out value="${sub.name}"/></option>
                            </c:forEach>
                        </select>
                        ...
                        <input 
                            ...
                            id="installerDis" 
                            name="installerDis" 
                            value="<c:out value="${sessionScope.inst}"/>" disabled>
                        ...
                        <input 
                            ...
                            id="statusDis" 
                            name="statusDis" 
                            value="<c:out value="${sessionScope.order.status}"/>" disabled>
                    ...
                    <div class="col-sm">
                        ...
                        <div id="rowService">
                            <textarea 
                                ...
                                rows="5" disabled><c:forEach items="${sessionScope.order.services}" var="service"><c:out value="${service}"/>&#10</c:forEach>
                            </textarea>  
                        </div>
                        <div id="rowserviceEdit" hidden="true">
                            ...
                            <div class="form-inline mt-3">
                                <input 
                                    ...
                                    value="0" type="text" 
                                    id="sqf" 
                                    name="sqf" disabled onkeypress="return isNumberKey(event)">Sqft
                                <input 
                                    class="form-control mr-2 text-right" 
                                    value="0" 
                                    type="text" 
                    ...
                    <div class="col-sm">
                        ...
                        <label 
                            class="mt-2 text-dark">Order Total: $<c:out value="${sessionScope.order.total}"/>.00
                        </label></br> 
                        <label 
                            class="mt-2 text-dark">Pay Installer: $<c:out value="${sessionScope.order.toPay}"/>.00
                        </label></br>
                        <a 
                            class="font-weight-bold ml-4 mt-4" 
                            id="clickToSee" href="<c:out value="${sessionScope.order.pic}"/>" data-toggle="lightbox">
                        ...
                        <small>
                            <label 
                                class="mt-4 text-dark">Order added by:</br> <c:out value="${sessionScope.userName}"/> on
                            </label>
                                <label 
                                    class="mt-4 text-dark" id="addedDate"><c:out value="${sessionScope.order.dateAdded}"/>
                                </label>
                        </small>          
                    </div>
                </div>
