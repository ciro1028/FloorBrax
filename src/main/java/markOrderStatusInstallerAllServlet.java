 ...
 * @author Ciro
 */
@WebServlet(urlPatterns = {"/markOrderStatusInstallerAllServlet"})
public class markOrderStatusInstallerAllServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            orderList = installer.getOrdersByDate(installer.getId(), start, end);
            
            session.setAttribute("orderList", orderList);
            
            response.sendRedirect("installer/InstallerView.jsp");
        }
    }
