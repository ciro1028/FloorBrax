        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="input-group mt-2">
                    ...
                    <input class="form-control text-right mb-2" type="text" value="$<c:out value="${sessionScope.total}"/>.00">
                </div>
            </div>
        </div>
    </div>
                ...
                <td class="text-center align-middle"><label id="<c:out value="${order.orderNum}&"/>"><c:out value="${order.status}"/></label></br>
                  <small>
                      <a id="<c:out value="${order.orderNum}*"/>" 
                         href="<c:url value="http://floor.us-east-1.elasticbeanstalk.com/markOrderStatusInstallerAllServlet">
