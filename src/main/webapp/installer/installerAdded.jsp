<%-- 
    Document   : installerAdded
    Created on : May 17, 2018, 5:46:17 PM
    Author     : Ciro
--%>
    ...
    <div class="container mt-4">
        <div class="row">
               <div class="col-sm">
                ...
                <div class="col-sm">
                    <button class="btn btn-primary float-right mt-4" type="button" data-toggle="modal" data-target="#deleteModal">Delete Installer</button> 
                </div>
            </div>
