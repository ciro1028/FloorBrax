...
<body>
  ...
  <div class="container">
    ...
    <div class="container">
        <form:form action="getSubdivision" method="post" modelAttribute="subdivision">
            <div class="input-group mt-4">
                <form:input path="name" class="form-control" type="text" placeholder="Enter Name of Subdivision" required="true" />
	            ...
	            <table class="table table-striped">
	              <thead>
	                <tr>
	                  ...
	                  <th class="text-center">View Subdivision</th>
	                </tr>
	              </thead>
	              <tbody>
	                <tr>
	                  ...
	                  <td class="text-center">${sub.address}</td>
	                  <td class="text-center">
	                  	<c:url var="viewSubdivisionLink" value="/subdivision/viewSubdivision">
							<c:param name="subdivisionId" value="${sub.id}"></c:param>
						</c:url> <a class="btn btn-primary" href="${viewSubdivisionLink}">View</a>
	                  </td>
	                </tr>
	              </tbody>
	            </table>
    ...
    <div class="container">
        <div class="row">
            <button class="btn btn-link" type="submit" onclick="showAll()">Show all subdivisions</button>
        </div>
    </div>
