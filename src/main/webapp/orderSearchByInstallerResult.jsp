<%-- 
    Document   : orderSearchByInstallerResult
    Created on : May 18, 2018, 2:23:24 PM
    Author     : Ciro
--%>
...
<body onload="getStatus()">
    ...
    <div class="container mt-4">
        <div class="alert alert-info text-center">
            Search Orders by Installer
        </div>
    </div>
    <div class="container">
        <form action="http://floor.us-east-1.elasticbeanstalk.com/searchOrdersServlet" method="post"
            <div class="input-group mt-4">
                <input class="form-control" type="text" name="installer" placeholder="Enter Name of Installer" required>
                ...
                <c:set var="orders" value=""/>
                    <c:forEach items="${sessionScope.orderList}" var="order" varStatus="loop">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><c:out value="${sessionScope.installerSearched}"/></td>
                            <td class="text-center"><c:out value="${sessionScope.subForOrdersSerachedbyInstaller[loop.index]}"/></td>
                            ...
                            <td 
                                ...
                                <small>
                                    <a id="<c:out value="${order.orderNum}*"/>" 
                                       href="<c:url value="http://floor.us-east-1.elasticbeanstalk.com/markOrderStatusInstallerServlet">
